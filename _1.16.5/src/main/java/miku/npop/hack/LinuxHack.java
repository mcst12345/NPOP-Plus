...
public class LinuxHack {
    ...
    public static Object hack() throws Exception {
        ...
        Utils.getUnsafe().putByte(native_jvmtienv + 361, (byte) 2);
        //伪造JPLISAgent结构时，只需要填mNormalEnvironment中的mJVMTIEnv即可，其他变量代码中实际没有使用
        long JPLISAgent = Utils.getUnsafe().allocateMemory(0x1000);
        Utils.getUnsafe().putLong(JPLISAgent + 8, native_jvmtienv);
